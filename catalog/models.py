...
#     """Model representing a Languague (e.g. English, Japanese, Chinese, etc."""
...
class Book(models.Model):
    ...
    # Genre class has already been declared so we can specify the object above.
    ...
    def display_genre(self):
        ...
        genre in Admin. (because Genre is ManyToManyField, a Book has 1 or many genres)
        """
...
class BookInstance(models.Model):
    ...
    # Define a selection list for status
    LOAN_STATUS = (
        ('m', 'Maintenance'),
        ('o', 'On loan'),
        ('a', 'Available'),
